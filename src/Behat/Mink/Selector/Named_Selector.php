 ...
 */
class Named_Selector implements Selector_Interface
{
    ...
    private $selectors = ['fieldset' => <<<XPATH
    .//fieldset
     ...
     */
    public function register_named_xpath($name, $xpath)
    {
     ...
     * @param string $to
     */
    protected function register_replacement($from, $to)
    {
